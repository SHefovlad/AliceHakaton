...
def resp():
    ...
    # Обучение
    if req["request"]["original_utterance"].lower() in ["да", "давай", "поехали", "так точно", "ок", "окей", "погнали", "вперед", "начинай"] and a4 == True:
        ...
        if req["request"]["original_utterance"].lower() in ["брось кубики", "бросай", "кинь кубики", "кидай", "кинь", "брось"] and a1 == True:
            ...
            response_text = 'Наконец наступил мой ход. Я бросаю кубики. Мне выпало 5+5=10. Я попала на вашу недвижимость и плачу вам 20. Чтобы я платила вам больше - улучшайте свою недвижимость Если готовы начать, то скажите "Начать игру".'
            a5 = False
        else:
            response_text = 'Извините, какие-то помехи, повторите по-другому пожалуйста.'
    elif["request"]["original_utterance"].lower() in ["правила", "правила", "правила", "правила", "правила"]:
        ...
        if["request"]["original_utterance"].lower() in ["дальше", "далее", "да", "ага", "давай", "поехали"] and b1 == True:
            ...
            b1 = False
        elif["request"]["original_utterance"].lower() in ["дальше", "далее", "да", "ага", "давай", "поехали"] and b2 == True:
            ...
            b2 = False
        elif["request"]["original_utterance"].lower() in ["дальше", "далее", "да", "ага", "давай", "поехали"] and b3 == True:
            response_text = 'Каждый раз, когда игроки доходят до поля "Начало", они получают 200 к своему капиталу. Едем дальше?'
            b3 = False
        elif["request"]["original_utterance"].lower() in ["дальше", "далее", "да", "ага", "давай", "поехали", "едем", "вперед"] and b4 == True:
